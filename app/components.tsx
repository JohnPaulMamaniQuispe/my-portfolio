...
export const MatrixRain: React.FC = () => {
  useEffect(() => {
    ...
    // Cubrir toda la ventana (de header a footer)
    canvas.width = window.innerWidth;
    canvas.height = window.innerHeight;

    // Letras y símbolos variados (versión original)
  ...
  // Fondo negro sólido, letras verdes cayendo por toda la pantalla
  return <canvas id="matrix-canvas" className="fixed top-0 left-0 w-full h-full" style={{opacity: 1, pointerEvents: 'none', zIndex: 0}} />;
};
